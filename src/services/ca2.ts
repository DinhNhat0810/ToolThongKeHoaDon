...
export const Laythongdiep200_Traveca202va204CA2 = async (
  startDate: string,
  endDate: string
): AxiosPromise<ResponseType> => {
  const soapEnvelope = `
...
export const Laythongdiep303thieu_MLTDiepCA2 = async (
  startDate: string,
  endDate: string,
  MLTDiep: string
): AxiosPromise<ResponseType> => {
  ...
  <soap12:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://www.w3.org/2003/05/soap-envelope">
  <soap12:Body>
    <Laythongdiep303thieu_MLTDiep xmlns="http://tempuri.org/">
      <tungay>${startDate}</tungay>
      <denngay>${endDate}</denngay>
      <MLTDiep>${MLTDiep}</MLTDiep>
    </Laythongdiep303thieu_MLTDiep>
  </soap12:Body>
</soap12:Envelope>
      `;
...
export const LaythongdiepThua_MLTDiepCA2 = async (
  startDate: string,
  endDate: string,
...
export const LaythongdiepTru1_MLTDiepCA2 = async (
  startDate: string,
  endDate: string,
  MLTDiep: string
): AxiosPromise<ResponseType> => {
